<div class="card border-2">
    <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div class="h4 card-title mb-0">Price Range</div>
        ...
        <div class="table-responsive">
            ...
            @if ($priceData->count())
                <table class="table table-bordered mb-0">
                    ...
                    <tbody>
                        @foreach ($priceData as $index => $row)
                            <tr>
                                <td>{{ $priceData->firstItem() + $index }}</td>
                                <td>{{ $row->country }}</td>
                ...
                <div class="mt-3">
                    {{ $priceData->onEachSide(1)->links(data: ['scrollTo' => false]) }}
                </div>
            @else
                <div class="text-center py-3 text-muted">No price data found</div>
            @endif
