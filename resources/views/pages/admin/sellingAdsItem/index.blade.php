            ...
            <div class="card">
                ...
                <div class="card-body pt-2">
                    <div class="row g-3 align-items-center justify-content-between mb-3">
                        <div class="col-lg-9">
                            <form method="GET" action="{{ route('admin.selling.adsItems.index') }}" class="row g-2">
                                <!-- Search -->
                                ...
                                @if (isset($asins) && $asins->count() > 0)
                                    @foreach ($asins as $asin)
                                        <tr class="odd">
                                            ...
                                            <td>
                                                <a
                                                    href="{{ $asin ? route('admin.selling.adsItems.details', [$asin->asin1, 'campaign' => 'SP', 'period' => '1d']) : '#' }}">
                                                    {{ $asin?->asin1 ?? '--' }}
                                                </a>
                                            </td>
                                            ...
                                            <td>
                                                <div class="dropdown" style="position: relative;">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu">
                                                        <li>
                                                            <a href="{{ route('admin.selling.adsItems.details', $asin->asin1) }}"
                                                                class="dropdown-item">
                    ...
                    <p class="text-muted">
                        <span class="badge badge-soft-info">Note :</span> Click on the <span
                            class="text-primary">ASIN</span> to navigate to the selling Ads Item
                        dashboard
