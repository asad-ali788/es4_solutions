    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Amazon ADS - ASIN Campaigns SB</h4>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                ...
                <div class="card-body pt-2">
                    <div class="row g-3 align-items-center justify-content-between mb-3">
                        <div class="col-lg-9">
                            {{-- Search Form --}}
                            <form method="GET" action="{{ route('admin.ads.keyword.campaignAsinsSb') }}" id="filterForm"
                                class="row g-2">
                                <!-- Search -->
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-nowrap dt-responsive nowrap w-100 table-hover">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-danger text-center fw-bold">No ASINs available.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
