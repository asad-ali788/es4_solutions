    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Amazon Ads - View Keyword Live</h4>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-lg-9">
                            ...
                            <form method="GET" action="{{ route('admin.viewLive.keyword') }}"
                                ...
                                <input type="text" name="campaign_id" class="form-control" placeholder="Campaign ID"
                                    value="{{ request('campaign_id') }}" style="max-width:200px;" />
                                <input type="text" name="keyword_id" class="form-control" placeholder="Keyword ID"
                                    value="{{ request('keyword_id') }}" style="max-width:200px;" />
