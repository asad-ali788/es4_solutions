    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Amazon Ads - View Keyword for Ad Group</h4>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-lg-9">
                            ...
                            <form method="GET" action="{{ route('admin.viewLive.keywordForAdGroup') }}"
                                ...
                                <x-elements.campaign-select :campaigns="['SP' => 'SP', 'SB' => 'SB']" :value="request('campaign')" />
                                    <input type="text" name="adGroupId" class="form-control" placeholder="AdGroup ID"
                                        value="{{ request('adGroupId') }}" style="max-width:200px;" />
                                    <input type="text" name="campaignId" class="form-control" placeholder="Campaign ID"
                                        value="{{ request('campaignId') }}" style="max-width:200px;" />
