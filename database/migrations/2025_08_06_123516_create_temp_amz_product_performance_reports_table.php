...
return new class extends Migration
{
    ...
    {
        Schema::create('temp_amz_ads_product_performance_report', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('sales30d', 10, 2)->nullable();
    ...
    {
        Schema::dropIfExists('temp_amz_ads_product_performance_report');
    }
};
