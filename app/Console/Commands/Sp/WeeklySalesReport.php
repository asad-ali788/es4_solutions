...
use App\Services\WeeklyReportCreateService;
...
class WeeklySalesReport extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:weekly-sales-report';
    ...
    public function handle()
    {
        ...
        $service = app(WeeklyReportCreateService::class);
        ...
        Log::channel('spApi')->info('✅ WeeklySalesReport Generated.', $response);
